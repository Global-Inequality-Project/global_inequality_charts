// Global objects
window.chart_data = {}
window.path_to_charts2 = "/wp-content/plugins/globalinequalities-charts/includes/modules/Charts/gip_chart_interface-main/"
...
function createChartInterface({ chartID, chartTitle, chartDescription, chartSources, renderFunc, pathToData, topMargin }) {
    ...
    if (pathToData == null) { pathToData = `${window.path_to_charts}/${chartID}/${chartID}.csv` }
